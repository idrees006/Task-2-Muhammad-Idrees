...
A fairness-focused machine learning project built with Python (PyTorch) and Google Colab that demonstrates bias mitigation using the **FairFace dataset**. This project is part of the **DecodeLabs AI Engineering Internship (Batch 2026)**.
